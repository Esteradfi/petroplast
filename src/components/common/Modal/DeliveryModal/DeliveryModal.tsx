    ...
    return (
        <div className={styles.modalContent}>
            ...
            <p className={styles.text}>
                <span className={styles.red}>Бессрочная акция: </span>бесплатная доставка по Санкт-Петербургу при заказе от 50 тыс. рублей. Чтобы воспользоваться этим предложением, просто позвоните или напишите нам.
            </p>
